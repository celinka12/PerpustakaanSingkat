...
final class LoansViewModel: ObservableObject {
    ...
    func saveNewLoan() async throws {
        ...
        if pickedMember == nil && name.isEmpty {
            errorMessage = "Nama anggota harus diisi."
            throw NSError(domain: "CreateLoan", code: 1)
        }
        if selectedBookIDs.isEmpty {
            errorMessage = "Pilih minimal 1 buku."
        ...
        do {
            ...
            errorMessage = "Gagal memproses anggota: \(error.localizedDescription)"
            throw error
        }
        ...
        do {
            ...
            errorMessage = "Gagal menyimpan peminjaman: \(error.localizedDescription)"
            throw error
        }
    }
